...
module SwaggerClient
  ...
  class ProductStatusRequest
    ...
    def list_invalid_properties
      ...
      if @status !~ Regexp.new(/APPROVED|READY_TO_SALE/)
        invalid_properties.push("invalid value for 'status', must conform to the pattern /APPROVED|READY_TO_SALE/.")
      end
    ...
    def valid?
      ...
      return false if @status !~ Regexp.new(/APPROVED|READY_TO_SALE/)
      return true
    end
    ...
    def status=(status)
      ...
      if status !~ Regexp.new(/APPROVED|READY_TO_SALE/)
        fail ArgumentError, "invalid value for 'status', must conform to the pattern /APPROVED|READY_TO_SALE/."
      end
