...
# Unit tests for SwaggerClient::InlineResponse200Items
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse200Items' do
  before do
    # run before each test
    @instance = SwaggerClient::InlineResponse200Items.new
  end
  ...
  describe 'test an instance of InlineResponse200Items' do
    it 'should create an instact of InlineResponse200Items' do
      expect(@instance).to be_instance_of(SwaggerClient::InlineResponse200Items)
    end
  end
  describe 'test attribute "expands"' do
    it 'should work' do
