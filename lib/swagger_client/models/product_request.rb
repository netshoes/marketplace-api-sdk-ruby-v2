...
module SwaggerClient
  ...
  class ProductRequest
    ...
    def self.swagger_types
      {
        ...
        :'attributes' => :'Array<ProductsAttributes>'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @product_group.to_s.length > 50
        invalid_properties.push("invalid value for 'product_group', the character length must be smaller than or equal to 50.")
      end

      if @product_group.to_s.length < 1
        invalid_properties.push("invalid value for 'product_group', the character length must be great than or equal to 1.")
      end
      ...
      if @product_type.to_s.length > 50
      ...
      if @brand.to_s.length > 50
        invalid_properties.push("invalid value for 'brand', the character length must be smaller than or equal to 50.")
      end

      if @brand.to_s.length < 1
      ...
      if @gender.to_s.length > 50
        invalid_properties.push("invalid value for 'gender', the character length must be smaller than or equal to 50.")
      end
      ...
      if @gender !~ Regexp.new(/Homem|Mulher|Unissex/)
        invalid_properties.push("invalid value for 'gender', must conform to the pattern /Homem|Mulher|Unissex/.")
      end
      ...
      if @size.to_s.length > 50
        invalid_properties.push("invalid value for 'size', the character length must be smaller than or equal to 50.")
      end

      if @size.to_s.length < 1
    ...
    def valid?
      ...
      return false if @sku.to_s.length > 50
      return false if @sku.to_s.length < 1
      return false if @product_group.nil?
      return false if @product_group.to_s.length > 50
      return false if @product_group.to_s.length < 1
      return false if @department.nil?
      return false if @department.to_s.length > 50
      return false if @department.to_s.length < 1
      return false if @product_type.nil?
      return false if @product_type.to_s.length > 50
      return false if @product_type.to_s.length < 1
      return false if @brand.nil?
      return false if @brand.to_s.length > 50
      return false if @brand.to_s.length < 1
      ...
      return false if @gender.to_s.length > 50
      return false if @gender.to_s.length < 1
      return false if @gender !~ Regexp.new(/Homem|Mulher|Unissex/)
      return false if @size.nil?
      return false if @size.to_s.length > 50
      return false if @size.to_s.length < 1
    ...
    def product_group=(product_group)
      ...
      if product_group.to_s.length > 50
        fail ArgumentError, "invalid value for 'product_group', the character length must be smaller than or equal to 50."
      end

      if product_group.to_s.length < 1
        fail ArgumentError, "invalid value for 'product_group', the character length must be great than or equal to 1."
      end
    ...
    def brand=(brand)
      ...
      if brand.to_s.length > 50
        fail ArgumentError, "invalid value for 'brand', the character length must be smaller than or equal to 50."
      end
    ...
    def gender=(gender)
      ...
      if gender.to_s.length > 50
        fail ArgumentError, "invalid value for 'gender', the character length must be smaller than or equal to 50."
      end
      ...
      if gender !~ Regexp.new(/Homem|Mulher|Unissex/)
        fail ArgumentError, "invalid value for 'gender', must conform to the pattern /Homem|Mulher|Unissex/."
      end
    ...
    def size=(size)
      ...
      if size.to_s.length > 50
        fail ArgumentError, "invalid value for 'size', the character length must be smaller than or equal to 50."
      end
    ...
    def hash
      [sku, product_group, department, product_type, brand, name, description, color, flavor, gender, manufacturer_code, size, ean_isbn, height, width, depth, weight, video, images, attributes].hash
    end
